...
const HOLDING_TAX_ITEMS = [
  { id: '1',labelid:'h_apply', label: 'আবেদন',        icon: 'file-document-outline',screens:'HoldingTaxAbedon'  },
  { id: '2',labelid:'h_search', label: 'অনুসন্ধান',      icon: 'file-search-outline' ,screens:'HoldingTaxAnusandhan' },
  { id: '3',labelid:'h_enum', label: 'নাম্বার সংযুক্ত',     icon: 'calculator-variant-outline' ,screens:'EHoldingNumber' },
  { id: '4',labelid:'h_due', label: 'বকেয়া বিবরণী',     icon: 'clipboard-list-outline',screens:'BokeyaBiboroni' },
  { id: '5',labelid:'h_pay', label: 'কুইক পে',         icon: 'timer-outline',screens:'QuickPay' },
  { id: '6',labelid:'h_payment', label: 'পরিশোধের বিবরণ',  icon: 'credit-card-outline' ,screens:'OnlinePaymentDetails'},
];
...
const styles = StyleSheet.create({
  ...
  sidebarChildLabel: { color: Colors.primaryLight, fontSize: FontSizes.sm, fontWeight: '400' },
  ...
  logoutLabel: { color: '#FF6B6B', fontSize: FontSizes.md, fontWeight: '600' },
