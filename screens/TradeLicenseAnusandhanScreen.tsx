...
type Props = NativeStackScreenProps<any, 'TradeLicenseAnusandhan'>;
...
export function TradeLicenseAnusandhanScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.sectionTitle}>ট্রেড লাইসেন্স অনুসন্ধান</Text>
