...
const SEARCH_ITEMS = [
  { id: '1', label: 'নতুন',                  icon: 'file-document-plus-outline', route: 'HoldingSearch',       title: 'HoldingSearch' },
  { id: '2', label: 'নামজারি',               icon: 'account-switch-outline',      route: 'NamjariSearch',       title: 'NamjariSearch' },
  { id: '3', label: 'নয়াবাদি',              icon: 'home-plus-outline',           route: 'NayabadiSearch',      title: 'NayabadiSearch' },
  { id: '4', label: 'মুক্তিযোদ্ধার সুবিধা', icon: 'shield-star-outline',         route: 'FreedomFighterSearch',title: 'FreedomFighterSearch' },
];

export function HoldingTaxAnusandhanScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.sectionTitle}>হোল্ডিং ট্যাক্স অনুসন্ধান</Text>
